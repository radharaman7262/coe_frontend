...
import { behaviouralSensoryProcessing } from './utils.api';
...
const BehaviouralSensoryProcessing = () => {
    ...
    const mutation = useAppMutation({
        mutationFn: behaviouralSensoryProcessing,
        setLoader,
...
export default BehaviouralSensoryProcessing;
