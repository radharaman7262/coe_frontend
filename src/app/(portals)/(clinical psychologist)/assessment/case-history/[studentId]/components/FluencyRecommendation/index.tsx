...
import { calculateFluencyPercentage, mapCPApiToState } from './constant';

import { useGetCaseHistoryFormDetails } from '../../../queries';

import { submitFluencyRecommendation } from './utils.api';

import styles from './styles.module.scss';

export const FLUENCY_THERAPY_OPTIONS = [
    {
        key: 'fluencyTherapy',
    ...
    {
        key: 'parentEducation',
        label: 'Parent education on reducing communicative pressure',
    },
    {
        key: 'classroomAwareness',
        label: 'Classroom awareness / Teacher sensitization',
    },
    {
        key: 'slowRate',
        label: 'Practice slow rate, pausing techniques',
    },
    {
        key: 'easyOnset',
        label: 'Easy onset / Light articulatory contact strategies',
    },
    {
        key: 'counselingReferral',
        label: 'Counseling referral (if anxiety/emotional response is high)',
    },
    {
        key: 'peerGroup',
        label: 'Peer support group / Play-based group therapy',
    },
];

const FluencyRecommendation = () => {
    ...
    const mutation = useAppMutation({
        mutationFn: submitFluencyRecommendation,
        setLoader,
        ...
        <div>
            <div className={styles['recommendation-container']}>
                <div className={styles.section}>
                    ...
                    <div className={styles.list}>
                        {FLUENCY_THERAPY_OPTIONS.map((item) => (
            ...
            <div className={styles.footer}>
                <div className={styles.actions}>
                    ...
                    >
                        {`${calculateFluencyPercentage(selected, inputs)} %`}
                    </Text>
                    <Button
                        label='save'
                        StartIcon={<DocIcon />}
...
export default FluencyRecommendation;
