import { FineMotorFormKeys, FineMotorFormType } from './type';

export const INITIAL_STATE: FineMotorFormType = {
    [FineMotorFormKeys.COMMENTS]: '',
    [FineMotorFormKeys.GENERAL]: '',
    [FineMotorFormKeys.HAND_DOMINANCE]: '',
};
