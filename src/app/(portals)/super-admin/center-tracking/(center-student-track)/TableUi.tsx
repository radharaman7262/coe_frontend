...
import { COLUMNS as constantColumns, CENTRE_TRACKING_TEXT as text } from './constant';
...
const TableUi = (props: tableUiProps) => {
    ...
    return (
        <Table
            ...
            noDescriptionContainer='Add Center through Center Setup'
        >
            <div className={styles['table-row']}>
                <Input
                    name='search'
                    value={tableFilter}
                    placeholder={text.searchByStaffName}
