...
import { EMOTIONAL_OUTCOME_QUESTIONS, SCALE_OPTIONS } from './constant';

import { behaviouralOutcomeProcessing } from './utils.api';
...
const BehaviouralOutcomeProcessing = () => {
    ...
    const isFormComplete = EMOTIONAL_OUTCOME_QUESTIONS.every((q) => formData[q.key] !== undefined);

    const mutation = useAppMutation({
        mutationFn: behaviouralOutcomeProcessing,
        setLoader,
    ...
    const handleSubmit = () => {
        const rawData = EMOTIONAL_OUTCOME_QUESTIONS.map((q) => ({
            questionId: q.id,
            key: q.key,
    ...
    return (
        <div className={styles.container}>
            ...
            >
                {EMOTIONAL_OUTCOME_QUESTIONS.map((q) => {
...
export default BehaviouralOutcomeProcessing;
