...
import FormField, { TableValue } from './FormSecondField';

import FormLayout from './FormSecondLayout';
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const DynamicTableForm = <T extends string, V extends Record<T, any>>(
    props: DynamicFormProps<T, V>,
) => {
    const {
        schema,
        onSubmit,
