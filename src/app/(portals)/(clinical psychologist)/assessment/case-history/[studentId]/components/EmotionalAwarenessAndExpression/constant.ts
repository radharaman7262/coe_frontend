import { EmotionalAwarenessFormKeys, EmotionalAwarenessFormType } from './type';

export const INITIAL_STATE: EmotionalAwarenessFormType = {
    [EmotionalAwarenessFormKeys.BEHAVIOURS]: '',
};
